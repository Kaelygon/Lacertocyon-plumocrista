...
**Lacertocyon plumocrista** (*feather crested lizard dog*), also known as *feather maned dragon* or simply *maned dragon*, is a large Lacertherid that shares traits with modern carnivorans, specifically canidae and felidae.  
Although the name suggests similarities to reptiles and canines, L. plumocrista belongs to the distinct family Lacertheridae. Many of these traits are a result of [convergent evolution](https://en.wikipedia.org/wiki/Convergent_evolution).  
...
### Physiology
- Maned dragons have long [digitigrade](https://en.wikipedia.org/wiki/Digitigrade "Stands on toes unlike plantigrades"), which enable them to see in tall foliage, making their gait akin to maned wolves.
...
- Maned dragons can thrive in wet seasons and near bodies of water. Their remnant semi-aquatic features make them decent swimmers, but this is not enough to outcompete more sophisticated species such as crocodiles. In bodies of water where the competition is not as fierce, they may exhibit similar ambush tactics to crocodiles.
...
- The species quickly adapted and evolved digitigrade legs, bigger ears, and improved eyesight to better suit outside water.  
...
- Outside the water, the fur didn't need to be as dense, but the fur strands on the back grew in width and length and eventually started to resemble feathers. This later became the recognizable mane.
...
These features have either proven beneficial or haven't posed significant hindrance. Thus, there hasn't been a reason to phase them out.
- Venomousness  
...
Most of these concepts are derived from real-life examples, using [Wikipedia](https://en.wikipedia.org/) as the main source.  
...
- [Concept art of a feral maned dragon](https://www.deviantart.com/caecuss/art/Tiena-Feral-876502282) (There will be more accurate illustrations in the future)  
